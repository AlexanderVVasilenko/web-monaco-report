...
from src.store_data import read_abbreviations_and_create_racers, read_and_create_race, read_lap_time_and_create_races
from src.models import Race, Racer, LapTime
...
def client():
    ...
    api_app.config["WTF_CSRF_ENABLED"] = False
...
def test_read_and_create_race(client):
    ...
    assert race_obj.location == "Monte Carlo"
